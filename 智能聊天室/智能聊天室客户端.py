...
class Client(wx.Frame):
    def __init__(self):
        ...
        wx.Frame.__init__(self,None,title=self.name+'智能问答聊天室客户端',size=(450,680),pos=(100,50))
        # 界面布局
    ...
    def recv_data(self):
        while self.isConnected:
            text = self.client_socket.recv(8192).decode('utf-8')
